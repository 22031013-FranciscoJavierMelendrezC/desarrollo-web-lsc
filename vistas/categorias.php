    ...
    <script>
      var accion; //indicar si se graba, consulta, modifica, elimina
      var table;
      ...
      $(document).ready(function() {
        ...
        var modal = $('#mdlGestionarCategoria');

        modal.on('mousedown', function(event) {
          isDragging = true;
          var modalOffset = modal.offset();
          var mouseX = event.pageX - modalOffset.left;
          var mouseY = event.pageY - modalOffset.top;
      ...
      document.getElementById("btnGuardarCategoria").addEventListener("click", function() {
        ...
        var validation = Array.prototype.filter.call(forms, function(form) {
          ...
          if (form.checkValidity() === true) {
            ...
            var titulo_msj = "Datos guardados con èxito";
            Swal.fire({
      ...
      /* ======================================================================================
    EVENTO AL DAR CLICK EN EL BOTON CANCELAR Y CERRAR VENTA AÑADIR CATEGORIA
    =========================================================================================*/
