 ...
 <aside class="main-sidebar sidebar-dark-primary elevation-4">
    ...
    <div class="sidebar">
      ...
      <nav class="mt-2">
        ...
        <li class="nav-item">
            <a style="cursor: pointer;" class="nav-link active" onclick="CargarContenido('vistas/dasboard.php','content-wrapper')" >
          ...
          <li class="nav-item">
          <a style="cursor: pointer;" class="nav-link" onclick="CargarContenido('vistas/reporte.php','content-wrapper')" >
              <i class="nav-icon fas fa-th"></i>
              <p>
                Reportes
              </p>
  ...
  <script>
    $(".nav-link").on('click',function(){
      $(".nav-link").removeClass('actuve');
      $(this).addClass('actuve');
    })
    </script>